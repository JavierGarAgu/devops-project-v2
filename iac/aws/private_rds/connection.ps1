...
$keyFileName = "admin_id_rsa"
$privateKeyPath = "$sshDir\admin_id_rsa"

if (-not (Test-Path $privateKeyPath)) {
    terraform output -raw admin_private_key_pem | Set-Content -Path $privateKeyPath -Encoding ascii -Force
